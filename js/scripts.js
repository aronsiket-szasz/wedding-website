$(document).ready(function () {
    ...
    $(function () {
      ...
      var weddingDate = new Date('Jul 19, 2025 13:00 GMT+0100').getTime();
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Áronin ja Lotan häät",

            // Event start date
            start: new Date('Jul 19, 2025 13:00'),
            ...
            end: new Date('Jul 19, 2025 23:59'),

            // Event Address
            address: 'Aitoniementie 268, 33680 Tampere',

            // Event Description
            description: "Lämpimästi tervetuloa todistamanaa Áronin ja Lotan hääpäivää sekä seuraamaan jännityksellä sanommeko toisillemme 'tahdon'. Mikäli teillä tulee kysyttävää voitte olla yhteydessä Ároniin numerolla 0404160951."
        }
    });
